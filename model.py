...
This module defines a lightweight **baseline MLP** and a
**Graph Attention Network (GAT)** for multi‑label classification on the
ogbn‑proteins dataset.  The architectures mirror those used in the
report but are simplified to run on CPU‑only machines with limited
memory.  All models output 112 logits corresponding to protein function
labels.
